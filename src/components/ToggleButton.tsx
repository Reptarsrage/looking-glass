      ...
      <div
        className={clsx(
          ...
          value
            ...
            : 'bg-slate-900/10 ring-slate-900/5 dark:bg-slate-50/10 dark:ring-slate-50/5'
        )}
      >
        <div
          className={clsx(
            'h-4 w-4 rounded-full bg-white shadow-sm ring-1 ring-slate-700/10 dark:ring-slate-200/10 transition duration-200 ease-in-out',
            value && 'translate-x-4'
          )}
        ></div>
      </div>
