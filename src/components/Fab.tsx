...
const Fab = forwardRef<HTMLButtonElement, FabProps>(function Button({ children, className, ...passThroughProps }, ref) {
  return (
    <button
      ref={ref}
      className={clsx(
        'bg-slate-50 text-black border inline-flex items-center justify-center rounded-full border-slate-300 transition duration-150 cursor-pointer select-none',
